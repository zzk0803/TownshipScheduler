...
public class DemoDataGenerator {
     ...
     */
    private static final WarehouseLocation START_LOCATION = new WarehouseLocation(
            Shelving.newShelvingId(COL_A, ROW_1),
            Shelving.Side.LEFT,
            0
    );
    ...
    private static final Map<ProductFamily, List<String>> SHELVINGS_PER_FAMILY = Map.of(
            ...
            List.of(newShelvingId(COL_A, ROW_1), newShelvingId(COL_A, ROW_2)),

            ProductFamily.FRESH_FOOD,
            List.of(newShelvingId(COL_A, ROW_3)),

            ProductFamily.MEET_AND_FISH,
            List.of(newShelvingId(COL_B, ROW_2), newShelvingId(COL_B, ROW_3)),

            ProductFamily.FROZEN_PRODUCTS,
            List.of(newShelvingId(COL_B, ROW_2), newShelvingId(COL_B, ROW_1)),

            ProductFamily.DRINKS,
            List.of(newShelvingId(COL_D, ROW_1)),

            ProductFamily.SNACKS,
            List.of(newShelvingId(COL_D, ROW_2)),
            ...
            List.of(newShelvingId(COL_E, ROW_2), newShelvingId(COL_E, ROW_1)),

            ProductFamily.PETS,
            List.of(newShelvingId(COL_E, ROW_3))
    );

    private static long currentId = 0;

    private static final List<ProductFamilyPair> PRODUCTS = List.of(
            new ProductFamilyPair(new Product(
                    nextId(),
                    "Kelloggs Cornflakes",
                    30 * 12 * 35,
                    null
            ), ProductFamily.GENERAL_FOOD),
            new ProductFamilyPair(
                    new Product(nextId(), "Cream Crackers", 23 * 7 * 2, null),
                    ProductFamily.GENERAL_FOOD
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Tea Bags 240 packet", 2 * 6 * 15, null),
                    ProductFamily.GENERAL_FOOD
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Tomato Soup Can", 10 * 10 * 10, null),
                    ProductFamily.GENERAL_FOOD
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Baked Beans in Tomato Sauce", 10 * 10 * 10, null),
                    ProductFamily.GENERAL_FOOD
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Classic Mint Sauce", 8 * 10 * 8, null),
                    ProductFamily.GENERAL_FOOD
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Raspberry Conserve", 8 * 10 * 8, null),
                    ProductFamily.GENERAL_FOOD
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Orange Fine Shred Marmalade", 7 * 8 * 7, null),
                    ProductFamily.GENERAL_FOOD
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Free Range Eggs 6 Pack", 15 * 10 * 8, null),
                    ProductFamily.FRESH_FOOD
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Mature Cheddar 400G", 10 * 9 * 5, null),
                    ProductFamily.FRESH_FOOD
            ),
            new ProductFamilyPair(new Product(nextId(), "Butter Packet", 12 * 5 * 5, null), ProductFamily.FRESH_FOOD),

            new ProductFamilyPair(
                    new Product(nextId(), "Iceberg Lettuce Each", 2500, null),
                    ProductFamily.FRUITS_AND_VEGETABLES
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Carrots 1Kg", 1000, null),
                    ProductFamily.FRUITS_AND_VEGETABLES
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Organic Fair Trade Bananas 5 Pack", 1800, null),
                    ProductFamily.FRUITS_AND_VEGETABLES
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Gala Apple Minimum 5 Pack", 25 * 20 * 10, null),
                    ProductFamily.FRUITS_AND_VEGETABLES
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Orange Bag 3kg", 29 * 20 * 15, null),
                    ProductFamily.FRUITS_AND_VEGETABLES
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Fairy Non Biological Laundry Liquid 4.55L", 5000, null),
                    ProductFamily.HOUSE_CLEANING
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Toilet Tissue 8 Roll White", 50 * 20 * 20, null),
                    ProductFamily.HOUSE_CLEANING
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Kitchen Roll 200 Sheets x 2", 30 * 30 * 15, null),
                    ProductFamily.HOUSE_CLEANING
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Stainless Steel Cleaner 500Ml", 500, null),
                    ProductFamily.HOUSE_CLEANING
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Antibacterial Surface Spray", 12 * 4 * 25, null),
                    ProductFamily.HOUSE_CLEANING
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Beef Lean Steak Mince 500g", 500, null),
                    ProductFamily.MEET_AND_FISH
            ),
            ...
            new ProductFamilyPair(
                    new Product(nextId(), "Pork Cooked Ham 125G", 125, null),
                    ProductFamily.MEET_AND_FISH
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Chicken Breast Fillets 300G", 300, null),
                    ProductFamily.MEET_AND_FISH
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "6 Milk Bricks Pack", 22 * 16 * 21, null),
                    ProductFamily.DRINKS
            ),
            ...
            new ProductFamilyPair(
                    new Product(nextId(), "Alcohol Free Beer 4 Pack", 30 * 15 * 30, null),
                    ProductFamily.DRINKS
            ),
            new ProductFamilyPair(new Product(nextId(), "Pepsi Regular Bottle", 1000, null), ProductFamily.DRINKS),
            new ProductFamilyPair(
                    new Product(nextId(), "Pepsi Diet 6 x 330ml", 35 * 12 * 12, null),
                    ProductFamily.DRINKS
            ),

            new ProductFamilyPair(new Product(nextId(), "Schweppes Lemonade 2L", 2000, null), ProductFamily.DRINKS),
            new ProductFamilyPair(
                    new Product(nextId(), "Coke Zero 8 x 330ml", 40 * 12 * 12, null),
                    ProductFamily.DRINKS
            ),
            new ProductFamilyPair(
                    new Product(nextId(), "Natural Mineral Water Still 6 X 1.5Ltr", 6 * 1500, null),
                    ProductFamily.DRINKS
            ),

            new ProductFamilyPair(
                    new Product(nextId(), "Cocktail Crisps 6 Pack", 20 * 10 * 10, null),
                    ProductFamily.SNACKS
            )
    );
    ...
    public void startup(@Observes StartupEvent startupEvent) {
        ...
        List<Trolley> trolleys = buildTrolleys(
                TROLLEYS_COUNT,
                BUCKET_COUNT,
                BUCKET_CAPACITY,
                START_LOCATION
    ...
    private List<Product> buildProducts() {
        return PRODUCTS.stream().map(productFamilyPair -> {
            ...
            WarehouseLocation warehouseLocation = new WarehouseLocation(
                    shelvingIds.get(shelvingIndex),
                    shelvingSide,
                    shelvingRow
            );
            return new Product(
                    productFamilyPair.getProduct().getId(),
    ...
    public void validateBucketCapacity(int bucketCapacity) {
        if (bucketCapacity < getMaxProductSize()) {
            throw new IllegalArgumentException("The selected bucketCapacity: " + bucketCapacity + ", is lower than the maximum product size: " + getMaxProductSize() + "." + " However for a matter of simplicity the problem was simplified on the assumption that products can always fit in a trolley bucket." + " Please use a higher value");
        }
    }

    public static int getMaxProductSize() {
        return PRODUCTS.stream().mapToInt(productFamilyPair -> productFamilyPair.getProduct().getVolume()).max().orElse(
                0);
    }

    public enum ProductFamily {
        GENERAL_FOOD, FRESH_FOOD, MEET_AND_FISH, FROZEN_PRODUCTS, FRUITS_AND_VEGETABLES, HOUSE_CLEANING, DRINKS, SNACKS, PETS
    }
