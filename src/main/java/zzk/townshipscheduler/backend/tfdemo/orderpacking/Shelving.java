...
/**
 * Represents the products container.
 * <p>
 * In the order picking problem the warehouse
 * is represented as a set of shelvings that are organized into columns and rows.
 * Each shelving has two sides
 * where the products can be stored, and a number of rows.
 *
 * @see Warehouse
 */
