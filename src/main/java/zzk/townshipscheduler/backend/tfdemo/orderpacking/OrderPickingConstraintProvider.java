...
import static zzk.townshipscheduler.backend.tfdemo.orderpacking.Warehouse.calculateDistance;
    ...
    Constraint requiredNumberOfBuckets(ConstraintFactory constraintFactory) {
        return constraintFactory
                ...
                .groupBy(
                        ...
                        sum((trolley, order, orderTotalVolume) -> {
                            return calculateOrderRequiredBuckets(
                                    orderTotalVolume,
