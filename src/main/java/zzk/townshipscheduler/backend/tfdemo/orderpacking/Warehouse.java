...
/**
 * Models the warehouse where the order picking problem is formulated
 * and is a static structure composed of shelvings organized in columns and rows.
 * <p>
 * A shelving can be identified by the warehouse column
 * and row number where it's placed.
 * <p>
 * The store products are located on the shelvings,
 * each shelving can contain products on the LEFT and RIGHT sides,
 * and on a row on the particular shelving side.
 *
 * <p>
