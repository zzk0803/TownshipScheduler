...
public class TownshipSchedulingProblem {
    ...
    public static final int HARD_INNER_CHAOS_SEQUENCE_AND_DATETIMESLOT = 0;

    public static final int HARD_BROKEN_FACTORY_ABILITY = 1;

    public static final int HARD_BROKEN_PRODUCE_PREREQUISITE = 2;

    public static final int HARD_BROKEN_DEADLINE = 3;
