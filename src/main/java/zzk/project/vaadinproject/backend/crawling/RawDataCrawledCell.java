...
@NoArgsConstructor
@AllArgsConstructor
public final class RawDataCrawledCell
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RawDataCrawledCell that)) return false;
    ...
    @Override
    public RawDataCrawledCell clone() {
        try {
            RawDataCrawledCell cloned = (RawDataCrawledCell) super.clone();
