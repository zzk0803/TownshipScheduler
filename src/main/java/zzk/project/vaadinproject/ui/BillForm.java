...
import zzk.project.vaadinproject.backend.persistence.BillType;
import zzk.project.vaadinproject.backend.persistence.Goods;
import zzk.project.vaadinproject.ui.components.BillDurationField;
import zzk.project.vaadinproject.ui.components.GoodsCategoriesPanel;
...
public class BillForm
    ...
    public BillForm(
        ...
        this.presenter.setBillForm(this);
        setupView();
    ...
    private Component assembleFooterPanel() {
        ...
        submit.addClickListener(submitClick -> {
            presenter.onSubmit();
            UI.getCurrent().navigate(BillView.class);
        });
